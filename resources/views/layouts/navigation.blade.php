    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <a href="{{ route('cart') }}">
                    <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/shopping-cart--v1.png"
                        alt="shopping-cart--v1" />

                </a>

                <div x-data="dropdown()">
                    <button class="btn btn-white" id="open-color-menu-arrow" x-spread="trigger">
                        {{ Auth::user()->name }}
                    ...
                    <div class="dropdown-list" id="color-menu-arrow" x-spread="dropdown" x-cloak>
                        ...
                        <a href="/" class="dropdown-item">Buy Product</a>
                        <a href="{{ route('checkOut') }}" class="dropdown-item">Checout Page</a>
